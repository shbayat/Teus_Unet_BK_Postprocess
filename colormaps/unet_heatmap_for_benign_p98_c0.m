...
cut_axial=1536;
downsample_rate=6;
data_name = 'RF_DS_A0_RBL_04'; %P98, core0, 256x140
data_name_mask='masked_DS_A0_RBL_04';
path_data = 'Z:\shared\images\ProstateVGH-2\Data\Patient98\2019-11-20-9-50\BMode\ROI_Data\Down_Sample\';
...
path_mask = 'Z:\shared\images\ProstateVGH-2\Data\Patient98\2019-11-20-9-50\BMode\ROI_Data\Down_Sample\';
...
pred=squeeze(prediction(43,:,:,2)); % core 0 p98
%% load Masek RF_DS
mask_RF=imread([path_mask,'masked_DS_A0_RBL_04.jpg']);  %prediction:(105, 256, 128, 2)
figure
imagesc(mask_RF)
...
img=imread('Z:\shared\images\ProstateVGH-2\Data\Patient98\2019-11-20-9-50\BMode\ROI_Data\TestImages\BMROI_test_0.bmp');
