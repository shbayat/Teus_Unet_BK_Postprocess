        ...
        function obj = ScanConversion(varargin)
            ...
            if nargin > 0
                ...
                elseif ( (obj.Rt > 0.0) && (obj.Rm <= 0.0) )
                    ...
                    obj.minX = -tan( obj.nTheta/2.0 * obj.dTheta ) * obj.maxY;
                    obj.maxX =  tan( obj.nTheta/2.0 * obj.dTheta ) * obj.maxY;
...
%                     obj.maxZ =  obj.nPhi/2.0 * obj.dPhi;	
                ...
                if nargin == 14
                    ...
                    obj.nXD = obj.nX;
                    obj.nYD = obj.nY;
                    obj.minX = -obj.nX*obj.dX/2;
                    obj.maxX = obj.nX*obj.dX/2
...
%             end
            ...
            if( obj.nZ == 1 )
                F=griddedInterpolant(obj.ttSC,obj.trSC,permute(dataIn,[2 1]),'spline',ExtrapMethod);
                out = F(obj.ptSC,obj.prSC);
            else
%                 out = interp3(tt,tr,tp,dataIn,pt,pr,pp,'spline',0);
                F = griddedInterpolant(obj.ttSC,obj.trSC,obj.tpSC,permute(dataIn,[2 1 3]),'spline',ExtrapMethod);
...
%             zz = permute(z,[2 1 3]);
            ...
            if( obj.nZ == 1 )
%                 out = interp2(xx,yy,dataIn,px,py,'spline',0);
                F = griddedInterpolant(obj.xSR,obj.ySR,permute(dataIn,[2 1]),'spline',ExtrapMethod);
                out = F(px,py);
            else
%                 out = interp3(xx,yy,zz,dataIn,px,py,pz,'spline',0);
                F = griddedInterpolant(obj.xSR,obj.ySR,obj.zSR,permute(dataIn,[2 1 3]),'spline',ExtrapMethod);
                out = F(px,py,pz);
            end
            out(isnan(out)) = 0;
            dataOut = permute(out,[2 1 3]);
...
%             obj.prSC = zeros(obj.nX,obj.nY,obj.nZ);
            ...
            if obj.probeType == 0 % CTCM
                ...
                ((0:(obj.nTheta-1)) - obj.nTheta/2)*obj.dTheta,...
                ((0:(obj.nPhi-1)) + 0.5 - obj.nPhi/2)*obj.dPhi);
            % ((0:(obj.nTheta-1))+ 0.5 - obj.nTheta/2)*obj.dTheta
            end
